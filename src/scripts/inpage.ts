...
interface HippoWallentWindow extends Window {
  hippoWallet?: HippoWeb3;
}

declare const window: HippoWallentWindow;
...
class HippoWeb3 {
  ...
  signAndSubmitTransaction(transaction: TransactionPayload) {
  ...
  _message(method: MessageMethod, args: { transaction?: TransactionPayload }) {
